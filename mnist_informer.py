...
texts = ["""
        ...
        значениями и правильными ответами. Градиентный поиск минимума позволяет найти наиболее оптимальное решение.""", 
        ...
        Выходной - количеству классов, которые пытаемся распознать""", 
        """График точности""", 
